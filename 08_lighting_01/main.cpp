...
void init_light()
{
    ...
    // set the light uniform color
    lightVecLoc = glGetUniformLocation(program, "uLightColor");
    glUniform4f(lightVecLoc, 1.5f, 0.5f, 0.5f, 1.0f);
}
...
void init_cube()
{
    ...
    /* Scale matrix */
    cube_model = glm::scale(cube_model, glm::vec3(0.3, 0.3, 0.3));

    /* Generate a translation matrix */
    x = start_x;
    y = start_y;
    z = start_z;
    cube_model = glm::translate(cube_model, glm::vec3(x, 0.0f, z));
...
void draw_cube()
{
    glUniformMatrix4fv(modelMatLoc, 1, GL_FALSE, glm::value_ptr(cube_model));
