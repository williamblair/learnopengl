...
static void updateUniforms()
{
    ...
    //glUniform3f(gUniformLocations["uLight.direction"],
    //    gLightDirection.x,
    //    gLightDirection.y,
    //    gLightDirection.z);
    // for spotlight
    ...
    // for positional light
    //glUniform1f(gUniformLocations["uLight.constant"], 1.0F);
    //glUniform1f(gUniformLocations["uLight.linear"], 0.22F);
    //glUniform1f(gUniformLocations["uLight.quadratic"], 0.20F);

    // for spotlight
    glUniform1f(gUniformLocations["uLight.cutoff"], glm::cos(glm::radians(12.5F)));
    glUniform1f(gUniformLocations["uLight.outerCutoff"], glm::cos(glm::radians(17.5F)));
...
int main(void)
{
    ...
    gUniformLocations["uLight.direction"] = glGetUniformLocation(gShaderProgram.id, "uLight.direction");
    ...
    // for positional light
    //gUniformLocations["uLight.constant"] = glGetUniformLocation(gShaderProgram.id, "uLight.constant");
    //gUniformLocations["uLight.linear"] = glGetUniformLocation(gShaderProgram.id, "uLight.linear");
    //gUniformLocations["uLight.quadratic"] = glGetUniformLocation(gShaderProgram.id, "uLight.quadratic");
    // for spotlight
    gUniformLocations["uLight.cutoff"] = glGetUniformLocation(gShaderProgram.id, "uLight.cutoff");
    gUniformLocations["uLight.outerCutoff"] = glGetUniformLocation(gShaderProgram.id, "uLight.outerCutoff");
