...
Texture gBrickWallNormalMap;

LightSource gLightSource;
glm::vec3 gLightPosition = glm::vec3(-2.0f, -2.0f, -4.0F);
...
static void draw()
{
    ...
    static GLuint uNormalMap = glGetUniformLocation(gShaderProgram.id, "uNormalMap");
...
int main(void)
{
    ...
    gBrickWallTexture = createTexture("brickwall.jpg");
    gBrickWallNormalMap = createTexture("brickwall_normal.jpg");
